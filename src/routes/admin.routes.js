...
router.put("/company-requests/approve/:id", adminController.approveCompanyRequest);  
router.put("/company-requests/reject/:id", adminController.rejectCompanyRequest);  
