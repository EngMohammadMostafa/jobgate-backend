...
const companyRoutes = require("./src/routes/companies.routes"); // 🆕 **مهم: يحتوي على login الآن**
...
// حذف هذا السطر: const companyAuthRoutes = require("./src/routes/companyAuth.routes"); // ❌ تم حذفه
...
app.use("/api/companies", companyRoutes); // ✅ **مهم: يضم login داخل المسار**
